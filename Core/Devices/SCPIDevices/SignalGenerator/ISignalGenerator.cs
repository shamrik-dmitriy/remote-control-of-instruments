...
namespace Core.Devices.SCPIDevices.SignalGenerator
{
    public interface ISignalGenerator : IScpiDevices
    {
        ...
        /// </summary>
        /// <param name="pulseModulationExternalPolarity"><see cref="PulseModulationExternalPolarity"/></param>
        ...
        /// <param name="pulseDelay"><see cref="PulseDelay"/></param>
        ...
        /// <param name="type"><see cref="PulseWidth"/></param>
        ...
        /// </summary>
        /// <param name="type"><see cref="PulseModulationInternal"/></param>
        ...
        /// </summary>
        /// <param name="pulseModulationSource"><see cref="PulseModulationSource"/></param>
        ...
        /// <param name="pulseWidth"><see cref="PulseWidth"/></param>
        ...
        /// <param name="pulsePeriod"><see cref="PulsePeriod"/></param>
